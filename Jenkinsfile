pipeline {
    ...
    stages {
        ...
        stage('Docker Deploy') {
            ...
            docker container run --restart always --name api-registry-webservice -p 9001:9001 -d api-registry-webservice && docker network connect travel-management-network api-registry-webservice
            '''
            }
        }
    }
